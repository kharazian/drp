...
export const parentButtonClass = cn(
  "h-auto min-h-[var(--density-sidebar-parent-min-h)] rounded-xl border border-transparent bg-sidebar-accent/25 px-3 py-2 text-sidebar-foreground/88 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]",
  baseIconOnlyButtonClass,
  "group-data-[collapsible=icon]:rounded-lg",
)

export const leafButtonClass = cn(
  "h-auto min-h-[var(--density-sidebar-leaf-min-h)] rounded-lg px-3 py-2 text-sidebar-foreground/72 transition-all duration-200 hover:bg-sidebar-accent/45 hover:text-sidebar-foreground",
  baseIconOnlyButtonClass,
)

export const childButtonClass =
  "h-auto min-h-[var(--density-sidebar-child-min-h)] rounded-lg px-3 py-2 text-[13px] text-sidebar-foreground/68 transition-all duration-200 hover:translate-x-0.5 hover:bg-sidebar-accent/35 hover:text-sidebar-foreground"
